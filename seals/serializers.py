...
from .validators import validate_seals_image
...
class SealSerializer(serializers.ModelSerializer):
    ...
    def get_primary_image(self, obj):
        ...
        if img is None:
            return None
        return SealImageSerializer(img, context=self.context).data

    def get_images_count(self, obj):
        return obj.images.count()


class SealListSerializer(serializers.ModelSerializer):
