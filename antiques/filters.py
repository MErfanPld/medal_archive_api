...
from .models import Antique, AuthenticityStatus, ConditionGrade


class AntiqueFilter(django_filters.FilterSet):
    ...
    object_type = django_filters.CharFilter(field_name='object_type', lookup_expr='icontains')
