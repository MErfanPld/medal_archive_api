...
class Antique(models.Model):
    ...
    category = models.ForeignKey(
        ...
        related_name='antiques_items', verbose_name='دسته‌بندی',
    )

    # آنتیک
    object_type = models.CharField(max_length=120, blank=True, default='', verbose_name='نوع شیء')
    material = models.CharField(max_length=150, blank=True, default='', verbose_name='جنس')
    style_period = models.CharField(max_length=150, blank=True, default='', verbose_name='سبک / دوره هنری')
    dimensions = models.CharField(max_length=150, blank=True, default='', verbose_name='ابعاد')
    ...
    technique = models.CharField(max_length=150, blank=True, default='', verbose_name='تکنیک ساخت')
    maker = models.CharField(max_length=150, blank=True, default='', verbose_name='سازنده / کارگاه')
    provenance = models.TextField(blank=True, default='', verbose_name='پیشینه مالکیت')
    condition_detail = models.TextField(blank=True, default='', verbose_name='جزئیات وضعیت')
    restoration_notes = models.TextField(blank=True, default='', verbose_name='یادداشت مرمت')
    estimated_age = models.CharField(max_length=80, blank=True, default='', verbose_name='قدمت تخمینی')
