...
class Stamp(models.Model):
    ...
    category = models.ForeignKey(
        ...
        related_name='stamps_items', verbose_name='دسته‌بندی',
    )

    # تمبر
    face_value = models.CharField(max_length=50, blank=True, default='', verbose_name='ارزش اسمی چاپ‌شده')
    denomination = models.CharField(max_length=80, blank=True, default='', verbose_name='واحد پولی')
    issue_name = models.CharField(max_length=200, blank=True, default='', verbose_name='نام سری / انتشار')
    catalog_scott = models.CharField(max_length=50, blank=True, default='', verbose_name='شماره اسکات')
    catalog_michel = models.CharField(max_length=50, blank=True, default='', verbose_name='شماره میشل')
    perforation = models.CharField(max_length=50, blank=True, default='', verbose_name='دندانه')
    watermark = models.CharField(max_length=100, blank=True, default='', verbose_name='واترمارک')
    color = models.CharField(max_length=80, blank=True, default='', verbose_name='رنگ')
    printing_method = models.CharField(max_length=100, blank=True, default='', verbose_name='روش چاپ')
    gum_condition = models.CharField(max_length=80, blank=True, default='', verbose_name='وضعیت چسب')
    ...
    theme = models.CharField(max_length=150, blank=True, default='', verbose_name='موضوع')
