...
from .validators import validate_knives_image


class KnifeImageSerializer(serializers.ModelSerializer):
...
class KnifeSerializer(serializers.ModelSerializer):
    ...
    def get_primary_image(self, obj):
        ...
        if img is None:
            return None
        return KnifeImageSerializer(img, context=self.context).data

    def get_images_count(self, obj):
        return obj.images.count()


class KnifeListSerializer(serializers.ModelSerializer):
