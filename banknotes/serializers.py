...
class BanknoteSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Banknote
        fields = [
            'id', 'name', 'category', 'category_id', 'category_detail',
            'face_value', 'denomination', 'currency_name', 'serial_number', 'series',
            'signature', 'printer', 'color', 'size_length', 'size_width',
            'security_features', 'is_replacement',
            'country', 'year', 'historical_period', 'catalog_number',
            'condition', 'authenticity', 'authenticity_display',
            'purchase_date', 'purchase_location', 'seller', 'purchase_price',
            'purchase_currency', 'current_value', 'last_valuation_date',
            'cabinet_number', 'drawer_number', 'box_number', 'notes',
...
class BanknoteListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'authenticity_display', 'current_value', 'is_active',
